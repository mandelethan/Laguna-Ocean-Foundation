        ...
        <div className="max-w-[1320px] mx-auto space-y-12">
          <div>
            ...
            <p className="text-lg leading-relaxed">
              Here in Laguna Beach, you&apos;ll discover the best spots to explore the city&apos;s stunning natural beauty. Focused on the 6 unique tidepool locations, we provide all the details you need: what marine life to expect, the best times to visit, and tips for a safe and enjoyable experience. You&apos;ll also find information on other must-see landmarks around Laguna Beach to help you make the most of your visit. Click on our locations to find out more!
            </p>
          </div>
